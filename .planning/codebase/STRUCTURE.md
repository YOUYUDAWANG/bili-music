...
- Contains: Now-playing surface, playback controls, lyrics/MV/playlist/favorite/download sheets, gesture policy and list-window pure helpers.
- Key files: `BiliMusic/Features/Player/NowPlayingView.swift`, `BiliMusic/Features/Player/PlayerControlViews.swift`, `BiliMusic/Features/Player/PlayerSheetViews.swift`, `BiliMusic/Features/Player/PlayerGesturePolicy.swift`, `BiliMusic/Features/Player/PlayerListWindow.swift`, `BiliMusic/Features/Player/CLAUDE.md`

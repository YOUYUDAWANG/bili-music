...
- [ ] **PLAY-03**: Playback startup records timing checkpoints for tap, source resolution, AVPlayer item creation, play request, and first observed playback state so regressions are measurable.
